#!/bin/bash
#SBATCH --job-name=genomicsDBImport_nofilemap_ch15_21
#SBATCH -A highmem
#SBATCH -N 1
#SBATCH -n 128
#SBATCH -t 24:00:00
...
--genomicsdb-workspace-path $PROJHOME/data/seqs/aligned_reads_Ogor1.0/07_genomicsDB/gdb2/${line[0]}_genomicsDatabase \
-L ${line[0]} \
--batch-size 50 \
--tmp-dir tmpdir \
--reader-threads 4 &
